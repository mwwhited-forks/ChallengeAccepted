...
namespace MorseCode
{
    public class MorseCode
    {
        ...
        public string Decode(string input) => new string(input.Split(' ').Select(Map).ToArray());
        ...
        private IReadOnlyDictionary<char, string> _mapping = new Dictionary<char, string>
        {
              { 'A', ".-"    },
              { 'B', "-..."  },
              { 'C', "-.-."  },
